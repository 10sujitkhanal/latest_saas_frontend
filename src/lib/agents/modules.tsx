...
export const AGENT_MODULES: Record<AgentModuleType, AgentModuleDef> = {
  ...
  finance: { type: 'finance', label: 'Finance', module: 'Finance & Accounting', Icon: Banknote, chip: 'bg-amber-50 text-amber-600', badge: 'bg-amber-50 text-amber-700', built: false, tasks: ['Draft invoices', 'Recurring billing', 'Chase overdue', 'Categorise expenses', 'Cash-flow summary'] },
